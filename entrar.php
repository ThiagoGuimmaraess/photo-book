...
<head>
 ...
 <img  src="imagens/photobook.png" alt="Photo Book logo" title="Photo Book" id="logo">
  ...
  <div id="formulario-caixa">
   ...
   <form id="formulario" method="post" action="verifica-login.php">
	 ...
	 <?php if(isset($_GET["erro"])){
	...
	
	     {
		  ...
		  echo "<span align='center' style='color:red;  margin-bottom:10px; margin-top:10px'>Senha ou email incorretos</span>";
	...
	<a href="recuperar-senha">esqueceu a senha? Recupere-a</a>
